      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-8 text-sm">
            <div class="site-info">
              <a href="#"><span class="mai-call text-primary"></span> +977-9812515170</a>
              <span class="divider">|</span>
              <a href="#"><span class="mai-mail text-primary"></span> anugyasharm981@gmail.com</a>
            </div>
          </div>
...
@auth
<li class="nav-item">
              <a class="nav-link" href="{{url('appointment')}}">My  Appointment</a>
            </li>
